...
namespace VendingMachine
{
    public partial class SaldoOpwaarderen : Form
    {
        ...
        private void TextBoxSaldo_TextChanged(object sender, EventArgs e)
        {
            ...
            if (textBoxSaldo.Text == "€ 5,10")
            {
                MessageBox.Show("U bent over het maximale saldo gegaan");
                MessageBox.Show("10 cent is teruggestort");
                muntWaarde = 0;
                huidigeSaldo = 400;
                textBoxSaldo.Text = ("€ 5,00");
            }

            if (textBoxSaldo.Text == "€ 5,40")
            {
                MessageBox.Show("U bent over het maximale saldo gegaan");
                MessageBox.Show("40 cent is teruggestort");
                muntWaarde = 0;
                huidigeSaldo = 400;
                textBoxSaldo.Text = ("€ 5,00");
            }

            if (textBoxSaldo.Text == "€ 5,30")
            {
                MessageBox.Show("U bent over het maximale saldo gegaan");
                MessageBox.Show("30 cent is teruggestort");
                muntWaarde = 0;
                huidigeSaldo = 400;
                textBoxSaldo.Text = ("€ 5,00");
            }
